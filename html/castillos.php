<?php
    ...
    if (!$conexion) {
		...
		$resultado = mysqli_query($conexion,"select * from Elementos where Continente = '$variable'");
...
<div class="dropdown">
    ...
    <a href="/html/castillos.php?castillo=Europa">Castillos de Europa</a>
    <a href="/html/castillos.php?castillo=Africa">Castillos de Africa</a>
    <a href="/html/castillos.php?castillo=Asia">Castillos de Asia</a>
    <a href="/html/castillos.php?castillo=sudeste asiatico">Castillos de sudeste asiatico</a>
    <a href="/html/castillos.php?castillo=America">Castillos de America</a>
        </div>
</div>
<div class="dropdown">
    ...
    <a href="">Civilizaciones de Asia</a>
    <a href="">Civilizaciones del sudeste asiatico</a>
    <a href="">Civilizaciones de America</a>
        </div>
</div>
<div class="dropdown">
...
<div class="dropdown">
 ...
 <?php 
    while($castillo=mysqli_fetch_assoc($resultado)){

 ?>
 <h1><?php echo $castillo["Nombre"]?></h1>
<br>
<br>

 <p><?php echo $castillo["Introduccion"]?></p> 
...
<ul>
<?php 
  $id = $castillo["idElementos"];
  $fotos = mysqli_query($conexion,"select Ruta from Fotos where Elementos_idElementos ='$id'");

while(        $arregloFotos=mysqli_fetch_assoc($fotos)){?>
<li><img src="<?php echo $arregloFotos["Ruta"]?>" width="1350px" height="625" alt=""></li>
...
<br>
<br>
<p><?php echo $castillo ["descripcion"];?></p>
<br>
<br>
<?php
if($castillo["Categoria"]=="Civilizaciones"){?>
    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagenes/descarga.jpeg" class="d-block w-100" width="1046.4px"height="600">
           
          </div>
          <div class="carousel-item">
            <img src="../imagenes/seguro.png" class="d-block w-100" width="1046.4px"height="600">
            <div class="carousel-caption d-none d-md-block">
            
            </div>
          </div>
          <div class="carousel-item">
            <img src = "../imagenes/osvaldo.jpeg" class="d-block w-100" width="1046.4px"height="600">
            <div class="carousel-caption d-none d-md-block">
...
<div class="imagenes2"><img src="../imagenes/logo-Gmail-1.png" width="55px" height="50px">
</div>
...
<div class="imagenes2"><img src="../imagenes/nuevo-diseno-icono-x-logotipo-twitter-2023_1017-45418.avif" width="55px" height="50px">
</div>
<div class="doblepunto"><p>:</p>
</div>
<div class="texto4"><a href="https://www.youtube.com/watch?v=nq6_77PSV-Y&ab_channel=VSP7FOOTBALLEXTRA"><p>Twiter</p></a>
</div>
<div class="imagenes2"><img src="../imagenes/gratis-png-logo-iconos-de-computadora-logo-de-instagram-logo-de-instagram-thumbnail.png" width="55px" height="50px">
</div>
<div class="doblepunto"><p>:</p>
</div>
<div class="texto4"><a href="https://www.youtube.com/watch?v=nq6_77PSV-Y&ab_channel=VSP7FOOTBALLEXTRA"><p>Instagram</p></a>
</div>
<div class="imagenes2"><img src="../imagenes/png-transparent-youtube-play-button-computer-icons-youtube-youtube-logo-angle-rectangle-logo-thumbnail.png" width="55px" height="50px">
</div>
<div class="doblepunto"><p>:</p>
</div>
